			...
			<table class="gridtable"  id="table" style="margin:0 auto;" width=90%;>
				...
				<c:forEach items="${DeviceAndInfoList}" var="var" varStatus="vs">
				   <tr >
						...
						<c:if test="${vs.index+1==1}"><td  rowspan="${DeviceAndInfoList.size()}"><a class="aCJ"  id="cjid2" style="display:none;">采集中....</a><a class="aCJ"  id="cjid" style="cursor: pointer;" onclick="startcj()">开始采集</a></td></c:if>
