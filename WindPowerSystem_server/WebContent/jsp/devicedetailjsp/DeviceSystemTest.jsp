...
<script type="text/javascript">
 ...
 function js_method(type){
	...
	function autoHeight(){
		...
		$("#W_width").attr("style","min-height:"+autoheight+"px;max-height:"+autoheight+"px;overflow: auto;");
	}
</script>
</head>
	...
	<div class="hd_box">
		...
		<div class="nav_box">
			<ul>
				...
				<li><a href="javascript:js_method(2);"><i><strong class="S_11"></strong></i><span>参数监控</span></a></li>
				<li><a  href="javascript:js_method(3);"><i><strong class="S_12"></strong></i><span>示波器</span></a></li>
				<li class="li_icon"><a  href="javascript:js_method(4);"><i><strong class="S_13"></strong></i><span>调试面板</span></a></li>
				<li class="style_li"><a href="<%=basePath%>jsp/index.jsp"><i><strong class="S_14"></strong></i><span>首页</span></a></li>
			</ul>
			<hr />
		</div>
	</div>
		...
		<div class="right_main_div W_90">
			...
			<div class="table_box" id="fcmscsdd_sk" style="display: none;">
					...
					<div class="w_five">
						...
						<ul class="P_Label01 clearfix input_style ul_a">
							<li><span><select id="jc_sk_cs1"><option value="41">转矩给定</option>
										<option value="42">有功电流</option></select></span> <input style="width: 40% !important;"
								id="zj_value_sk" type="text" value="0"></li>

							<!-- 	<li><span>转矩给定</span> <input style="width: 40% !important;"
								id="zj_value_sk" type="text" value="0"></li> -->

							<li><span><select id="jc_sk_cs2"><option value="51">无功电流</option>
										<option value="52">无功功率</option>
										<option value="53">功率因素</option>
								</select></span> <input style="width: 40% !important;" id="wgdl_value_sk"
								type="text" value="10"></li>
							<!-- <li><span>无功电流</span> <input style="width: 40% !important;"
			...
			<div class="table_box" id="fcmscsdd_qgl" style="display: none;">
				...
				<div class="w_five">
					...
					<ul class="P_Label01 clearfix input_style ul_a">
						<li><span>网侧无功电流</span> <input style="width: 40% !important;"
							id="wg_value_qgl" type="text" value="0"></li>
						<li><span>网侧功率因素</span> <input style="width: 40% !important;"
							id="wdy_value_qgl" type="text" value="0"></li>
						<li><span>直流电压补偿</span> <input style="width: 40% !important;"
							id="zl_value_qgl" type="text" value="0"></li>
					</ul>
			...
			<!-- 状态 控制:双馈-->
			<div class="table_box" id="ztkz_sk" style="display: none;min-height:420px;max-height:580px;overflow: auto;">
				<div class="w_100">
			...
			<!-- 状态 控制:全功率-->
			<div class="table_box" id="ztkz_qgl" style="display: none;min-height:420px;max-height:580px;overflow: auto;">
				<div class="w_100">
					<div class="title_A">状态</div>
			...
			<!-- 控制模式 :双馈，全功率-->
			<div class="table_box" id="zzms" style="display: none;min-height:420px;max-height:580px;overflow: auto;"> 
				...
				<div class="w_100">
					...
					<div class="A_style clearfix">
						<a class="A_button01" title="007EH" href="javascript:void()"
							onclick="sendcodereq(this);">模式选择切换</a> &nbsp; &nbsp; &nbsp;     <a  style="margin-left:5%;" class="A_button01"
