...
<body style="overflow: hidden">
	...
	<div class="main_box clearfix">
		<div class="right_main_div W_90">
			...
			<div class="table_box" id="fcmscsdd" style="display: block;">
					...
					<div class="w_five">
						...
						<ul class="P_Label01 clearfix input_style ul_a">
							<li><span>网侧Iq(A)</span> <input style="width: 40% !important;"
								id="wg_value_hsfd" type="text" value="0"></li>
							<li><span>网侧Id(A)</span> <input style="width: 40% !important;"
								id="wdy_value_hsfd" type="text" value="0"></li>
							<li><span>Udc(V)</span> <input style="width: 40% !important;"
								id="zl_value_hsfd" type="text" value="0"></li>
						</ul>
					...
					<div class="w_five">
						...
						<ul class="P_Label01 clearfix input_style ul_a">
							<li><span>机侧Iq(A)</span> <input style="width: 40% !important;"
								id="zj_value_hsfd" type="text" value="0"></li>
							<li><span>机侧Id(A)</span> <input style="width: 40% !important;"
								id="wgdl_value_hsfd" type="text" value="0"></li>
							<li><span>转矩(Nm)</span> <input style="width: 40% !important;"
								id="wlyw_value_hsfd" type="text" value="0"></li>
						</ul>
					</div>
			...
			<!-- 状态 控制:双馈-->
			<div class="table_box" id="ztkz" style="display: none;min-height:380px;max-height:580px;overflow: auto;">
				<div class="w_100">
			...
			<!-- 控制模式 :海上风电-->
			<div class="table_box" id="zzms" style="display: none;min-height:380px;max-height:580px;overflow: auto;">
				...
				<div class="w_100">
					...
					<div class="A_style clearfix">
						<a class="A_button01" title="0079H" href="javascript:void()"
							...
							href="javascript:void()"  style="margin-left:5%;"  onclick="sendcodereq(this);"
							title="0089H">模式设置确认</a>
					</div>
				</div>
				<!-- 运行模式设置end -->
