...
//	updateMsg = window.setTimeout("updateSessionMsg()", 60000);
//    updateTimeout = window.setTimeout("updateProgress()", 1000);
    updateMsg = setInterval(function(){updateSessionMsg()}, 5000);
    updateTimeout = setInterval(function(){updateProgress()}, 1000);
