        ...
        <div class="right_main_div">
            <div class="W_width">
                ...
                <div class="table_box">
                   ...
                   <!--  <div style="display: ;" class="poput_box_b">
                        <p class="poput_title">新增
                            <a href="#"></a>
                        </p>
                        <ul class="ul_style">
                            <li><span>设备编号</span>
                            ...
                            <li><span>设备</span>
                                <select>
                                    <option value="陈锐11">陈锐11</option>
                                    <option value="陈锐12">陈锐12</option>
                                    <option value="陈锐13">陈锐13</option>
                                </select>
                            </li>
                            <li><span>ip地址</span>
                                <input type="text"></input>
