...
public class WindPowerReadModbusXmlAll_hsfd {
	...
	static List<String> iacliststr_sk = new ArrayList();
	static List<String> iacparameliststr_sk = new ArrayList();
	static List<String> appliststr_sk = new ArrayList();
	static List<String> appparameliststr_sk = new ArrayList();
...
//			插入sql语句到数据库中
			...
			iacliststr_sk = new ArrayList();
			iacparameliststr_sk = new ArrayList();
			appliststr_sk = new ArrayList();
			appparameliststr_sk = new ArrayList();
