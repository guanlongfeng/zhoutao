...
public class FirmwareUpgradeUtils {
	...
	public static void main(String[] args) {
		...
		// int upgradeStatus = 0;
		// try {
		// getUpgradeStatus("192.168.68.231", 502, upgradeStatus);
		// login("192.168.68.231", 502);
		// setSendData("192.168.68.231", 502);
		// getDeviceVersionNo("192.168.68.231", 502);
		// sendData("192.168.68.231", 502, "E:\\sumgrow\\CC.sgu");
		// quit("192.168.68.231", 502);
		// } catch (Exception e) {
		// e.printStackTrace();
		// }
		// setupdatedata("192.168.68.231", 502, "E:\\sumgrow\\CC.sgu");
	}
	...
	public static String getUpgradeStatus(String ip, int port, int status,String deviceId) {
		...
		// System.out.println("返回数据："+status);
		upgradeStatus = status;
		String requestr = "获取设备升级状态回复指令为:";
		for (int i = 0; i < recData.length; i++) {
			requestr += recData[i] + ",";
		}
		System.out.println(requestr);
