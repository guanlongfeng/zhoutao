...
//			timename = new String(timename.getBytes("ISO-8859-1"),"UTF-8"); 
	...
	public String exportExcel(@RequestParam("form_type") int form_type,@RequestParam("timename") String timename,
		...
		try {
			...
			String fileName = new String((typename+"_"+timename+"_"+format.format(new Date())).getBytes("gb2312"), "iso8859-1")+ ".xls";
	...
	@ResponseBody
	public BaseResponseData updateErrorRepair(@RequestParam("id") int id,
