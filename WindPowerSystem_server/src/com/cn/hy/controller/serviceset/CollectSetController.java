...
public class CollectSetController {
	...
	@ResponseBody
	public BaseResponseData updateCollectTimes(@RequestParam("real_time") int real_time,@RequestParam("history") int history){
		BaseResponseData data = new BaseResponseData();
		try {
			CollectTimes collectTimes = collectSetService.getCollectTimes();
	...
	*/
	...
	@ResponseBody
	public BaseResponseData updateDeviceType( @RequestParam("id") int id,
			@RequestParam("modbus_type") int modbus_type,@RequestParam("name") String name ) {
		 BaseResponseData data = new BaseResponseData();
		try {
			DeviceType deviceType = collectSetService.getDeviceTypeById(id);
			deviceType.setModbus_type(modbus_type);
	...
	*/
	...
	@ResponseBody
	public BaseResponseData updateDevice( @RequestParam("id") int id,
			@RequestParam("device_type_id") int device_type_id,@RequestParam("name") String name ) {
		 BaseResponseData data = new BaseResponseData();
		try {
	...
	*/
	...
	@ResponseBody
	public BaseResponseData insertDeviceMangInfo( 
			@RequestParam("xtype") int device_id,@RequestParam("typeName") String typeName,
			@RequestParam("armIp") String armIp,@RequestParam("armAddr") int armAddr,
			@RequestParam("wdspIp") String wdspIp,@RequestParam("wdspAddr") int wdspAddr,
			@RequestParam("jdspIp") String jdspIp,@RequestParam("jdspAddr") int jdspAddr){
		 BaseResponseData data = new BaseResponseData();
		try {
			//存设备表
			Device device=new Device();
	...
	*/
	...
	@ResponseBody
	public BaseResponseData checkIp( @RequestParam("armIp") String armIp,
	...
	*/
	...
	@ResponseBody
	public BaseResponseData editDeviceMangInfo( @RequestParam("id") int id,
			@RequestParam("xtype") int device_id,@RequestParam("typeName") String typeName,
			@RequestParam("armIp") String armIp,@RequestParam("armAddr") int armAddr,
			@RequestParam("wdspIp") String wdspIp,@RequestParam("wdspAddr") int wdspAddr,
			@RequestParam("jdspIp") String jdspIp,@RequestParam("jdspAddr") int jdspAddr){
	...
	*/
	...
	public BaseResponseData insertDeviceInfo( @RequestParam("device_id") int device_id,
			@RequestParam("d_type") String d_type,@RequestParam("ip") String ip, 
	...
	*/
	...
	@ResponseBody
	public BaseResponseData updateDeviceInfo(@RequestParam("id") int id,
			@RequestParam("device_id") int device_id,@RequestParam("d_type") String d_type, 
